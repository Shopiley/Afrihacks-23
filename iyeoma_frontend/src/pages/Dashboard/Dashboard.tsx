                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Progress w={'13.4rem'} mt={'1rem'} borderRadius={"17px"} colorScheme={"purple"} bg={"#00ccda"} value={54} size={"lg"}> <ProgressLabel fontSize={"13px"}>50%</ProgressLabel></Progress>
                            <Text color={"#000"} fontSize={"14px"} fontWeight={700} ml={'7.7rem'} >
                            Abba Baby👶🏾
                            </Text>
                        </Box>
                    </Box>
